		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My first Firori App",
									"targetURL": "#btpacademyfirstfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpacademyfirstfioriapp-display": {
								"semanticObject": "btpacademyfirstfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.academy.firstfioriapp",
									"url": sap.ui.require.toUrl("btp/academy/firstfioriapp")
								}
							}
						}
					}
